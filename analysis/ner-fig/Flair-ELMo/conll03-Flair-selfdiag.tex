...
\begin{tikzpicture}
  ...
  \begin{axis}[%ybar=1.0pt,
    ...
    xticklabels={spanAmb \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(0, .5]}, tokAmb \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(0, .5]}, spanFre \\ \textcolor{brinkpink}{(.173, 1]} \\ \textcolor{cyan}{0}, tokFre \\ \textcolor{brinkpink}{(.003, .015]} \\ \textcolor{cyan}{(.015, 1]}, spanLen \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(3, 6]}, sentLen \\ \textcolor{brinkpink}{(1, 7]} \\ \textcolor{cyan}{(16, 31]}, spanDen \\ \textcolor{brinkpink}{(.258, .429]} \\ \textcolor{cyan}{(.0222, .15]}, oovDen \\ \textcolor{brinkpink}{(.203, 1]} \\ \textcolor{cyan}{(.0667, .203]}},
    xtick=data,
    xmajorgrids=true,
    ymajorgrids=true,
    zmajorgrids=true,
