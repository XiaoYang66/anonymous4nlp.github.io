...
\begin{tikzpicture}
  ...
  \begin{axis}[%ybar=1.0pt,
    ...
    xticklabels={spanAmb \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(0, .5]}, tokAmb \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(0, .5]}, spanFre \\ \textcolor{brinkpink}{(.032, .173]} \\ \textcolor{cyan}{0}, tokFre \\ \textcolor{brinkpink}{(.003, .015]} \\ \textcolor{cyan}{(.015, 1]}, spanLen \\ \textcolor{brinkpink}{2} \\ \textcolor{cyan}{(3, 6]}, sentLen \\ \textcolor{brinkpink}{(1, 7]} \\ \textcolor{cyan}{(31, 124]}, spanDen \\ \textcolor{brinkpink}{(.429, 1]} \\ \textcolor{cyan}{(.0222, .15]}, oovDen \\ \textcolor{brinkpink}{(.203, 1]} \\ \textcolor{cyan}{(0, .0667]}},
    xtick=data,
    xmajorgrids=true,
    ymajorgrids=true,
    zmajorgrids=true,
